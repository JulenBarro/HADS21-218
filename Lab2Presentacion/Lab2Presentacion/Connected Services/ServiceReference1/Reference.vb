...
Namespace ServiceReference1
    ...
    Partial Public Class Service1Client
        ...
        Public Function GetMediaHoras(ByVal asignatura As String) As Integer Implements ServiceReference1.IService1.GetMediaHoras
            Return MyBase.Channel.GetMediaHoras(asignatura)
        End Function
        
        Public Function GetMediaHorasAsync(ByVal asignatura As String) As System.Threading.Tasks.Task(Of Integer) Implements ServiceReference1.IService1.GetMediaHorasAsync
